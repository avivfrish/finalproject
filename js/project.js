...
app.controller('ng-cases', function ($scope, $http,$compile, $interval, fileUpload, $window, $element, $timeout) {
    ...
    $scope.hidePages = function () {
        ...
        $("#loading_search_results_update").hide();
    ...
    $scope.clearUpdateBySearch = function()
    {
        ...
        document.getElementById("companyIdSearchedSearchedToUpdate").value = '';
        $scope.clearAlerts();
        $("#show_update_results").hide();
    ...
    $scope.insertNewComp = function()
    {
        ...
        /*else if (angular.isNumber(parseInt(document.getElementById("compID").value))){
            console.log("RSSD_ID is a number");
        }*/
        else {
            $("#loading_new_comp").show();
            $http({
                method: 'POST',
    ...
    $scope.showUpdateResults = function () {
        ...
        if ($scope.updateResultsFilterBy != "Contains" && $scope.updateResultsFilterBy != "Equals"){
            $scope.clearAlerts();
            $("#no_filter_update").show();
        }
        else {
            $("#loading_search_results_update").show();
            $http({
                method: 'POST',
    ...
    $scope.showMoreAboutResult = function (name) {
        ...
        document.getElementById(name).style.boxShadow = "#1F497D 4px 4px 4px 4px, rgba(0, 0, 0, 0.19) 0px 6px 20px 0px";
